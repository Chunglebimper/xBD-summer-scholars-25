...
def display(PATH):
    ...
    # show the image
    plt.axis('off')
    plt.savefig('output.tif', transparent=True, dpi=300, bbox_inches="tight", pad_inches=0.0)   # save the image
...
display(GEO_PATH)
splits = split_image.split_image('output.tif', 8, 8, False, True, output_dir='./processed')
